        		...
        		<div class="col-xs-12 col-sm-6 col-md-6">
		            <div class="well well-sm">
		                <div class="row">
		                    ...
		                    <table>
		                    <tr>
		                       <td nowrap style="text-align: right">Admin Name:</td><td>&nbsp;&nbsp;&nbsp;<c:out value="${sessionScope.pname}"/></td>
		                    </tr>
		                    <tr> 
		                       <td nowrap style="text-align: right">Email:</td><td>&nbsp;&nbsp;&nbsp;<c:out value="${sessionScope.pemail}"/></td>
		                    </tr>
		                    <tr> 
		                       <td nowrap style="text-align: right">Phone Number:</td><td>&nbsp;&nbsp;&nbsp;<c:out value="${sessionScope.pphone}"/></td>
		                    </tr>
		                    <tr>
		                       <td nowrap style="text-align: right">Staff ID:</td><td>&nbsp;&nbsp;&nbsp;<c:out value="${sessionScope.pstaff_no}"/></td>
		                    </tr>
		                    <tr>
		                       <td nowrap style="text-align: right">Company Name:</td><td>&nbsp;&nbsp;&nbsp;<c:out value="${sessionScope.pcompany_name}"/></td>
		                    </tr>  
		                     <tr>
