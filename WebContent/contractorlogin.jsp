...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<div class="container">
		...
		<%
			if(request.getSession().getAttribute("contractorLog") != null && request.getSession(false).getAttribute("contractorLog").equals(true))
			{
		...
		<c:if test="${not empty loginFirstVat}">
    		<p><font color="FF0000"><c:out value="${sessionScope.loginFirstVat}"/></font></p>
    		<c:remove var="loginFirstVat" scope="session" />
		</c:if>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="ContractorLogin" method="post" style="display: block;">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="#" class="forgot-password" onclick="return alert('Contact your Admin to reset your password.');">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
