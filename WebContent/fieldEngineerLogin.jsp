...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	<html lang="en">
	<head>
	  <title>Field Engineer Login</title>	  
	...
	<div class="container">
		...
		<%
			if(request.getSession().getAttribute("fieldengineerLog") != null && request.getSession().getAttribute("fieldengineerLog").equals(true))
			{
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="FieldEngineerLogin" method="post" style="display: block;">
