...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	<html lang="en">
	<head>
	  <title>Job Card View - Contractor</title>
	...
	%>
		...
		<c:if test="${not empty ApprovalError}">
			...
			<form action='Jobcard' method="POST" id="reg">
    			...
    			<div id="legend">
      				<legend class=""><font color="#FF6A6A">JOB CARD No: <c:out value="${sessionScope.job_card_noo}"/></font> <a style="float:right" href="Approve_Contractor" title='Approve Jobcard' data-toggle='tooltip'>APPROVE<span class='glyphicon glyphicon-ok'></span></a><a style="float:right" href="Reject_Contractor" title='Reject Jobcard' data-toggle='tooltip'><font color="FF0000">REJECT<span class='glyphicon glyphicon-remove'></span></font></a></legend>
      				</div>
