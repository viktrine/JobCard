			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="ProformaContractor" method="post" style="display: block;">
									
									<div class="form-group">
									<label>Contractor</label>
										<input type="text" name="contractor"  class="form-control" placeholder="Contractor" value="<c:out value="${sessionScope.contractorcname}"/>" readonly>
									</div>
