...
/**
 * Servlet implementation class DeleteEngineer
 */
@WebServlet("/DeleteEngineer")
public class DeleteEngineer extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("adminLog") != null)
		{
		    ...
		    try
			{
				...
				String engineer_DetailsDelete = "delete from engineerDetails where id = ?";
				ps = con.prepareStatement(engineer_DetailsDelete);
				ps.setInt(1, idd);
				int i = ps.executeUpdate();
				
				String engineerDetailsDelete = "delete from engineerPass where engineer_id = ?";
				pss = con.prepareStatement(engineerDetailsDelete);
				pss.setInt(1, idd);
