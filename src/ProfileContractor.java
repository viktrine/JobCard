...
/**
 * Servlet implementation class ProfileContractor
 */
@WebServlet("/ProfileContractor")
public class ProfileContractor extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{
			int id_value = (int) request.getSession(false).getAttribute("contractorLog");
			out.println("<html>");
