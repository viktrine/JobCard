...
/**
 * Servlet implementation class ViewParticularAdminDetails
 */
@WebServlet("/ViewParticularAdminDetails")
public class ViewParticularAdminDetails extends HttpServlet 
{
     ...
     */
    public ViewParticularAdminDetails() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("adminLog") != null)
		{
			...
			out.println("<html>");
			out.println("<head><title>Admin Details</title>");
