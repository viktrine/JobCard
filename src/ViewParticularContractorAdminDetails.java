...
/**
 * Servlet implementation class ViewParticularContractorAdminDetails
 */
@WebServlet("/ViewParticularContractorAdminDetails")
public class ViewParticularContractorAdminDetails extends HttpServlet 
{
     ...
     */
    public ViewParticularContractorAdminDetails() 
    {
        super();
		...
		if ((request.getSession().getAttribute("engineerLog") != null) || (request.getSession().getAttribute("adminLog") != null))
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/contractorDetailsAdmin.jsp");
				}
				out.print("</table>");
