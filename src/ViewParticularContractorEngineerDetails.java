...
/**
 * Servlet implementation class ViewParticularContractorEngineerDetails
 */
@WebServlet("/ViewParticularContractorEngineerDetails")
public class ViewParticularContractorEngineerDetails extends HttpServlet 
{
     ...
     */
    public ViewParticularContractorEngineerDetails() 
    {
        super();
		...
		if ((request.getSession().getAttribute("engineerLog") != null) || (request.getSession().getAttribute("adminLog") != null))
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/contractorDetailsEngineer.jsp");
				}
				out.print("</table>");
