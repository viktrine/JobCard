...
/**
 * Servlet implementation class ViewParticularFieldEngineerDetailsAdmin
 */
@WebServlet("/ViewParticularFieldEngineerDetailsAdmin")
public class ViewParticularFieldEngineerDetailsAdmin extends HttpServlet 
{
     ...
     */
    public ViewParticularFieldEngineerDetailsAdmin() 
    {
        super();
		...
		if ((request.getSession().getAttribute("contractorLog") != null) || (request.getSession().getAttribute("engineerLog") != null) || (request.getSession().getAttribute("adminLog") != null))
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/fieldEngineerDetailsAdmin.jsp");
				}
				out.print("</table>");
