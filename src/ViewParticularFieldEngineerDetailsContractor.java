...
/**
 * Servlet implementation class ViewParticularFieldEngineerDetailsContractor
 */
@WebServlet("/ViewParticularFieldEngineerDetailsContractor")
public class ViewParticularFieldEngineerDetailsContractor extends HttpServlet 
{
     ...
     */
    public ViewParticularFieldEngineerDetailsContractor() 
    {
        super();
		...
		if ((request.getSession().getAttribute("contractorLog") != null) || (request.getSession().getAttribute("engineerLog") != null) || (request.getSession().getAttribute("adminLog") != null))
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/fieldEngineerDetailsContractor.jsp");
				}
				out.print("</table>");
