...
/**
 * Servlet implementation class ViewParticularJobcardEngineer
 */
@WebServlet("/ViewParticularJobcardEngineer")
public class ViewParticularJobcardEngineer extends HttpServlet 
{
     ...
     */
    public ViewParticularJobcardEngineer() 
    {
        super();
		...
		if (request.getSession().getAttribute("engineerLog") != null)
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/jobcardDetailEngineer.jsp");
				}
				out.print("</table>");
