 ...
 */
@WebServlet("/ViewParticularJobcardField")
public class ViewParticularJobcardField extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewParticularJobcardField() {
        super();
		...
		if (request.getSession().getAttribute("fieldengineerLog") != null)
		{
			...
			try
			{
				...
				else
				{
					...
					response.sendRedirect("/jobcard/jobcardDetails.jsp");
				}
				out.print("</table>");
