...
/**
 * Servlet implementation class View_ContractorsEngineer
 */
@WebServlet("/View_ContractorsEngineer")
public class View_ContractorsEngineer extends HttpServlet 
{
     ...
     */
    public View_ContractorsEngineer() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("engineerLog") != null)
		{
			...
			try
			{
				...
				String contractors = "select * from managerDetails inner join contractorDetails on managerDetails.id= contractorDetails.manager_id where managerDetails.engineer_id = ?";
				...
				if(!rs.isBeforeFirst())
				{
		    		...
		    		out.print("alert('You have not registered any contrator...');");
				...
				else
				{
					...
					while(rs.next())
					{
						...
						out.print("<tr><td nowrap>"+counter+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+cname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+fname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+sname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+email+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+staff_id+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+registration_date+"&nbsp; &nbsp; &nbsp;</td>"
						 		+ "<td nowrap>"
						 		+ "&nbsp; &nbsp; &nbsp;<a href='ViewParticularContractorEngineerDetails?id="+id+"' title='View Pofile' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a> &nbsp; &nbsp; &nbsp;"
						 		...
						 		+ "<a href='ContractorPassRecovery?useremail="+email+"' title='Reset Password' data-toggle='tooltip'> Reset Password</a> &nbsp; &nbsp; &nbsp;</td></tr>");
						counter = counter + 1;
					}
