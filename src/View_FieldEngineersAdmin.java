...
/**
 * Servlet implementation class View_FieldEngineersAdmin
 */
@WebServlet("/View_FieldEngineersAdmin")
public class View_FieldEngineersAdmin extends HttpServlet 
{
     ...
     */
    public View_FieldEngineersAdmin() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("adminLog") != null)
		{
			...
			try
			{
				...
				String field_engineers = "select * from fieldEngineerDetails";
				...
				if(!rs.isBeforeFirst())
				{
		    		...
		    		out.print("alert('No Field Engineers');");
				...
				else
				{
					...
					while(rs.next())
					{
						...
						out.print("<tr><td nowrap>"+counter+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+fname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+sname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+phone_no+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+email+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+staff_id+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+registration_date+"&nbsp; &nbsp; &nbsp;</td>"
						 		+ "<td nowrap>"
						 		+ "&nbsp; &nbsp; &nbsp;<a href='ViewParticularFieldEngineerDetailsAdmin?id="+id+"' title='View Pofile' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a> &nbsp; &nbsp; &nbsp;"
