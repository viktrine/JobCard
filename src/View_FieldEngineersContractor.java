...
/**
 * Servlet implementation class View_FieldEngineersContractor
 */
@WebServlet("/View_FieldEngineersContractor")
public class View_FieldEngineersContractor extends HttpServlet 
{
     ...
     */
    public View_FieldEngineersContractor() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("contractorLog") != null)
		{
		    ...
		    {
		    	out.println("New Password: "+"<font color=\"00EE76\">"+updateSucess+"</font>");
			...
			try
			{
				...
				String jobcard_details = "select * from fieldEngineerDetails where contractor_id = ?";
				...
				if(!rs.isBeforeFirst())
				{
		    		...
		    		out.print("alert('You have not registered any Field Engineer');");
				...
				else
				{
					...
					while(rs.next())
					{
						...
						out.print("<tr><td nowrap>"+counter+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+fname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+sname+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+phone_no+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+email+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+staff_id+"&nbsp; &nbsp; &nbsp;</td><td nowrap>"+registration_date+"&nbsp; &nbsp; &nbsp;</td>"
						 		+ "<td nowrap>"
						 		+ "&nbsp; &nbsp; &nbsp;<a href='ViewParticularFieldEngineerDetailsContractor?id="+id+"' title='View Pofile' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a> &nbsp; &nbsp; &nbsp;"
