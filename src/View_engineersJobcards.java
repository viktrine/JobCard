...
/**
 * Servlet implementation class View_engineersJobcards
 */
@WebServlet("/View_engineersJobcards")
public class View_engineersJobcards extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getSession().getAttribute("engineerLog") != null)
		{
			...
			try
			{
				...
				String jobcard_details = "select * from jobcard_details where engineer_id = ? group by jobcard_details.jobcard_no order by jobcard_details.jobcard_no";
		...
		{
			request.getSession().setAttribute("loginFirst", "Please login to proceed");
